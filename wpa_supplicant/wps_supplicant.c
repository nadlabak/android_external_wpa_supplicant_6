...
#ifdef ANDROID
// BEGIN Motorola, dpn473, 07/08/2010, IKSTABLEONE-968 / WiFi Protected Set-up(IKSTABLEONE-214)
...
// BEGIN Motorola, dpn473, 07/08/2010, IKSTABLEONE-609 / WiFi Protected Set-up(IKSTABLEONE-214)
static void wpas_wps_timeout(void *eloop_ctx, void *timeout_ctx)
{
	struct wpa_ssid *ssid;
	int disabled;
