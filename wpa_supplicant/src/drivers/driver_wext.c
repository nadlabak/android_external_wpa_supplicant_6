...
static void wpa_driver_wext_finish_drv_init(struct wpa_driver_wext_data *drv)
{
	...
	if (wpa_driver_wext_get_ifflags(drv, &flags) != 0)
        ...
        /*
         * BEGIN Motorola, w19978, 1/18/2010, IKMAP-2826/IKMAP-4646
					   ...
					   struct wext_scan_data *data)
{
	...
	r->maxrate = data->maxrate; //Motorola, dcw476 , 6/26/2010,IKSTABLEONE-215
...
//BEGIN Motorola, dcw476 , 6/26/2010,IKSTABLEONE-215 Feature 29855, WiFi Ad-hoc support
